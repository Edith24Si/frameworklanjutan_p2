...
export default function Pelanggan() {
    ...
    const handleSave = (e) => {
        ...
        setData([{ id: `CUST-${String(data.length + 1).padStart(3, "0")}`, ...form }, ...data]);
        setShowForm(false);
                    ...
                    <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select className="w-full px-4 py-2.5 rounded-xl text-sm border border-white/5 outline-none text-gray-200"
                                style={{ background: "#13161f" }}
                                value={form.loyalty} onChange={e => setForm({ ...form, loyalty: e.target.value })}>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead style={{ background: "#13161f" }}>
                            {/* Di bagian THEAD, tambahkan header Aksi */}
