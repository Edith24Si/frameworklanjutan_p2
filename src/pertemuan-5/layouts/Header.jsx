            ...
            <div id="icons-container" className="flex items-center space-x-3 ml-4">
                ...
                <div id="notification-icon"
                    ...
                    <span id="notification-badge"
                        className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 rounded-full px-1.5 py-0.5 text-[9px] font-bold text-white"
                ...
                <div id="profile-container"
                    className="flex items-center space-x-3 border-l pl-4"
                    style={{ borderColor: "#ffffff0d" }}>
                    <span id="profile-text" className="text-sm" style={{ color: "#9ca3af" }}>
